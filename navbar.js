...
searchBox.setAttribute('class', 'transition duration-200 border border-gray-300 rounded-2xl py-3 px-3 flex items-center justify-center text-base font-sm text-black');
...
cartAmount.setAttribute('class', 'justify-items-center text-center px-2 py3 bg-red-500 rounded-2xl text-white');
cartAmount.setAttribute('style', "font-family: 'Prompt', sans-serif; font-size: 1.2em;");
